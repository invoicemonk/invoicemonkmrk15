...
import { ArrowRight, CheckCircle, HardHat, Smartphone, Receipt, FolderOpen, Shield, Clock } from 'lucide-react';
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-body-lg text-muted-foreground mb-8">
              Manage multiple projects, track job expenses, and invoice clients from anywhere. 
              Built for contractors who work on-site and on-the-go.
            </p>
